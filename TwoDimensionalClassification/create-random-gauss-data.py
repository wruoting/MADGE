...
new_classify_gauss_data = []
for element in ClassifyTwoGaussData:
    new_classify_gauss_data.append(list(np.multiply(element, [100, 7, 1])))

data_array = new_classify_gauss_data
data_array_str = 'ClassifyTwoGaussDataNonSquare'
