...
new_classify_circle_data = []
for element in ClassifyCircleData:
    new_classify_circle_data.append(list(np.multiply(element, [5000, 7, 1])))

data_array = new_classify_circle_data
data_array_str = 'ClassifyCircleDataNonSquare'
